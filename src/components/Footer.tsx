        ...
        >
          <motion.div variants={fadeUp} className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              {['instagram', 'facebook', 'whatsapp'].map((icon) => (
                <motion.a
                  key={icon}
                  href="#"
                ...
                >
                  <span className="material-symbols-outlined text-inverse-on-surface" style={{ fontSize: '18px' }}>
                    {icon === 'instagram' ? 'photo_camera' : icon === 'facebook' ? 'groups' : 'chat'}
                  </span>
                </motion.a>
              ))}
            </div>
